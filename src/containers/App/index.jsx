...
import {
  Container, Divider, Header, Icon, Image, List, Menu, Segment, Visibility, Responsive
    ...
    return (
      <div>
        ...
        <Container text>
          ...
          <Header as='h1' textAlign='center'>Experience</Header>
          <Divider horizontal>Modcam AB
            <Responsive as={'span'} minWidth={768}>
              {' - Front End Lead - Malmö, Sweden - 2016 -'}
            </Responsive>
          </Divider>
          <p>
          ...
          <Divider horizontal>HiQ Skåne AB
            <Responsive as={'span'} minWidth={768}>
          ...
          <Divider horizontal>Sony Mobile AB
            <Responsive as={'span'} minWidth={768}>
          ...
          <Divider horizontal>HiQ Karlskrona AB
            <Responsive as={'span'} minWidth={768}>
          ...
          <Divider horizontal>Telenor Sverige AB
            <Responsive as={'span'} minWidth={768}>
